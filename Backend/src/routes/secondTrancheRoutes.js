...
const {
	...
	getSecondById,
	updateSecondStatus,
} = require("../controllers/secondTrancheController");
...
router.get("/v2", authenticateAdmin, getAllSecnWithUserDetails);

router.get("/v1/:id", authenticateAdmin, getSecondById);

router.patch("/u1/:id", authenticateAdmin, updateSecondStatus);
