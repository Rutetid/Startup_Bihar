				...
				<div className="max-w-6xl mx-auto flex">
					...
					<div className="w-1/2 p-4">
						<form onSubmit={formik.handleSubmit}>
							{/* Form Fields */}
							<div className="mb-4">
								<label className="block mb-2" htmlFor="registrationNo">
									Registration No:
								</label>
								<input
							...
							<div className="mb-4">
								<label className="block mb-2" htmlFor="founderName">
									Founder Name:
								</label>
								<input
									className="border rounded w-full py-2 px-3"
							...
							<div className="mb-4">
								<label className="block mb-2" htmlFor="founderAadharNumber">
							...
							<div className="mb-4">
								<label className="block mb-2" htmlFor="coFounderNames">
									Co-Founder Names (comma-separated):
								</label>
								<input
									className="border rounded w-full py-2 px-3"
									id="coFounderNames"
							...
							<div className="mb-4">
								<label className="block mb-2" htmlFor="coFounderAadharNumbers">
									Co-Founder Aadhar Numbers (comma-separated):
								</label>
								<input
									className="border rounded w-full py-2 px-3"
							...
							<div className="mb-4">
								<label className="block mb-2" htmlFor="businessConcept">
									Business Concept:
								</label>
								<textarea
									className="border rounded w-full py-2 px-3"
							...
							<div className="mb-4">
								<label className="block mb-2" htmlFor="mobileNumbers">
					...
					<div className="w-1/2 p-4">
						<form onSubmit={formik.handleSubmit}>
							<div className="mb-4">
								<label className="block mb-2" htmlFor="websiteLink">
									Website Link:
								</label>
								<input
									className="border rounded w-full py-2 px-3"
							...
							<div className="mb-4">
								<label className="block mb-2" htmlFor="dpiitRecognitionNo">
							...
							<div className="mb-4">
								<label className="block mb-2" htmlFor="appliedIPR">
									Applied for IPR:
								</label>
								<select
									className="border rounded w-full py-2 px-3"
