	...
	const checkDocumentStatus = async (url) => {
		...
		try {
			...
			const statusMessages = {
				...
				accepted:
					"Document Status: Accepted - Your document has been approved.",
				rejected:
					"Document Status: Rejected - Your document has been rejected.",
			};

			alert(
				statusMessages[document.documentStatus] ||
					`Document Status: ${document.documentStatus} - Unknown status.`,
			);
		} catch (error) {
