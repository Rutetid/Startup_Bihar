		...
		if (id) {
			try {
				const response = await axios.get(
					`http://localhost:3000/api/acceleration/v2/${id}`,
					{
						headers: {
				...
				<table className="min-w-full bg-white">
					<tbody>
						...
						<tr>
							...
							<td className="py-4 px-4 border">{data.website}</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td className="py-4 px-4 border">{data.feesPerPerson}</td>
						</tr>
						<tr>
							<td className="py-4 px-4 border">Total rail fare/ air tickets and hotel room charges (INR)</td>
							<td className="py-4 px-4 border">{data.travelAndHotelCharges}</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td className="py-4 px-4 border">{data.totalFees}</td>
						</tr>
					</tbody>
				</table>
